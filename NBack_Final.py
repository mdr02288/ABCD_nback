...
if expInfo['Session'] == 'Practice':
    ...
    taskScreen1_3 = visual.TextStim(win=win,ori=0,name='taskScreen1_3',text='You will see the words "Target" or "2-Back"',font='Arial',pos=np.array([0,-2])*stimScale,height=textLetterSize,wrapWidth=wrapWidth,color='black',colorSpace='rgb',opacity=1,depth=-1.0)
    taskScreen1_4 = visual.TextStim(win=win,ori=0,name='taskScreen1_4',text='\nbefore each game starts.',font='Arial',pos=np.array([0,-2.5])*stimScale,height=textLetterSize,wrapWidth=wrapWidth,color='black',colorSpace='rgb',opacity=1,depth=-1.0)

    taskScreen2_1 = visual.TextStim(win=win,ori=0,name='taskScreen2_1',text='For "0-Back", press MATCH if you see a picture',font='Arial',pos=np.array([0,9])*stimScale,height=textLetterSize,wrapWidth=wrapWidth,color='black',colorSpace='rgb',opacity=1,depth=-1.0)
    ...
    screen1 = [taskScreen1_1,taskScreen1_2,taskScreen1_3,taskScreen1_4]
